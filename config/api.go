...
const IndexUrl = ApiRootUrl + "index/index"
const CatalogList = ApiRootUrl + "catalog/index"
const CatalogCurrent = ApiRootUrl + "catalog/current"  //分类目录当前分类数据接口

const AuthLoginByWeixin = ApiRootUrl + "auth/loginByWeixin" //微信登录

const GoodsCount = ApiRootUrl + "goods/count"  //统计商品总数
const GoodsList = ApiRootUrl + "goods/list"  //获得商品列表
const GoodsCategory = ApiRootUrl + "goods/category"  //获得分类数据
const GoodsDetail = ApiRootUrl + "goods/detail"  //获得商品的详情
const GoodsNew = ApiRootUrl + "goods/new"  //新品
const GoodsHot = ApiRootUrl + "goods/hot"  //热门
const GoodsRelated = ApiRootUrl + "goods/related"  //商品详情页的关联商品（大家都在看）